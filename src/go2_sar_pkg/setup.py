...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'map_to_odom_static = go2_sar_pkg.map_to_odom_static:main',
            'map_publisher_empty = go2_sar_pkg.map_publisher_empty:main',
            'pc_to_og = go2_sar_pkg.pc_to_og:main',
            ],
    },
)
